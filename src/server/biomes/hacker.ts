...
export const hacker: BiomeSpec = {
  ...
  structures: [
    ...
    "in your three-piece psychology and 1950's technobrain",
    ...
    "spoon-fed baby food at school when we hungered for steak",
  ...
  txt: `Another one got caught today, it's all over the papers.
Teenager Arrested in Computer Crime Scandal
Hacker Arrested after Bank Tampering
Damn kids. They're all alike.
